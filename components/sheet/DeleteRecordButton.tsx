...
export default function DeleteRecordButton({ recordId, contentId }: { recordId: string; contentId: string }) {
  ...
  return (
    <button
      ...
      disabled={deleting}
      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40 transition-colors font-bold text-[14px] disabled:opacity-50"
    >
