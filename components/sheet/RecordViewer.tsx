              ...
              <tr className="bg-slate-50 dark:bg-slate-950/50 text-[13px] sm:text-[14px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">
                {isServerContent ? (
                  <>
                    ...
                    <th className="px-3 sm:px-4 py-4 min-w-[100px] sm:min-w-[140px] max-w-[200px]">캐릭터명</th>
                    <th className="px-2 sm:px-3 py-4 w-14 sm:w-20 text-center leading-tight border-l border-slate-200 dark:border-slate-800 bg-blue-50/50 dark:bg-blue-900/10">매왕<br/>등수</th>
                    <th className="px-2 sm:px-3 py-4 w-14 sm:w-20 text-center leading-tight bg-blue-50/50 dark:bg-blue-900/10">컨텐츠<br/>등수</th>
                      ...
                      <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors whitespace-nowrap">
                        ...
                        <td className={`px-2 sm:px-3 py-3 text-center font-bold ${
                          !isAbsent && isNearTierBoundary(row.content_rank)
                            ...
                            : "bg-blue-50/10 dark:bg-blue-900/5 text-blue-600 dark:text-blue-400"
                        }`}>
