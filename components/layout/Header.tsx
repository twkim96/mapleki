...
export default async function Header() {
  ...
  return (
    <header className="h-20 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-xl sticky top-0 z-20 flex items-center justify-between px-10 border-b border-transparent transition-colors duration-200">
